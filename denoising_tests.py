...
Alot of this code was inspired from Dr. Sreenivas Bhattiprolu
...
for sigma in sigmas:
    ...
    io.imsave(gaussian_filename, gaussian_img)
...
for tv in TV_weights:
    ...
    io.imsave(tv_filename, denoise_TV)
...
io.imsave("Wavelet.tif", wavelet_smoothed)
...
for disc in disc_values:
    ...
    io.imsave(disc_filename, median_img)
...
for size in patch_sizes:
    for dist in patch_distances:
        ...
        io.imsave(NLM_filename, NLM_img)
...
for psd in sigma_psds:
    ...
    io.imsave(ALL_STAGES_filename, ALL_STAGES_img)
...
for psd in sigma_psds:
    ...
    io.imsave(HARD_filename, HARD_img)
